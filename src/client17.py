...
x_train, y_train = get_dataset(target=0, client=17)
...
class FlowerClient(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        r = model.fit(x_train[rnd*20:rnd*(20)+20], y_train[rnd*20:rnd*(20)+20], epochs=15,batch_size=4, verbose=0)
...
# x_train, y_train, x_test, y_test = get_dataset(target=0, client=17)
